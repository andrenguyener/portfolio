...
import { NavigationContext, useIsPageLoaded, useIsTopInView } from "./../../utils";
            ...
            >
                <Navigation>
                    ...
                    <CSSTransition
                        ...
                        unmountOnExit={true}
                        classNames="navigation__modal-container"
                    >
                        <Container topVisible={isActive && isTop}>
                            <Nav>
                                <List>
                                    <Item>
                                        <StyledLink>
