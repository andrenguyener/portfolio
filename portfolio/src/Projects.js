...
import {Image, Grid, Container, Modal, Responsive, Label, Icon, Header, Transition } from 'semantic-ui-react'
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            projects: 
                [ {
                    name: "drippy chat",
                    description: "Drippy is an instant messaging application \
                    ...
                    desktop: require('./assets/drippyclub-desktop.png'),
                    mobile1: require('./assets/drippyclub-mobile1.png'),
                    mobile2: require('./assets/drippyclub-mobile2.png'),
                    labels: ["React", "Node", "Go", "MongoDB", "Websocket", "RabbitMQ", "Redis"],
                    github: "https://github.com/andrenguyener/drippy-chat",
                    livedemo: "https://drippy.club"
                },
                {
                    name: "lac hong",
                    description: "Lac Hong is a Vietnamese non-profit organization that \
                    ...
                    desktop: require('./assets/lachong-desktop.png'),
                    mobile1: require('./assets/lachong-mobile1.png'),
                    mobile2: require('./assets/lachong-mobile2.png'),
                ...
                },
                 {
                    ...
                    description: "Epic Pet Health is a Seattle based company that team members \
                    ...
                    desktop: require('./assets/epicpethealth-desktop.png'),
                    mobile1: require('./assets/epicpethealth-mobile1.png'),
                    mobile2: require('./assets/epicpethealth-mobile2.png'),
                    labels: ["React", "HTML", "CSS", "Javascript"],
                 ...
                 {
                    name: "husky break",
                    description: "Husky Break is a student organization at the University of \
                    Washington. Developed their site to inform the public about them, showcase \
                    their members, and recruit more members.",
                    desktop: require('./assets/huskybreak-desktop.png'),
                    mobile1: require('./assets/huskybreak-mobile1.png'),
                    mobile2: require('./assets/huskybreak-mobile2.png'),
    ...
    render() {
        ...
        if (this.state.projects) {
            projectListDesktop = this.state.projects.map((project, index) => 
                <p key={index} onClick={(e) => {this.changeProject(index)}}> {project.name} </p>
            );
                    ...
                    <Container className="modal-container">
                        ...
                        <Modal.Description>
                                ...
                                <div className="modal-previews">
                                   <Icon name="github" size="big" onClick={()=> window.open(project.github, "_blank")}/>  <h4> github </h4> 
                                   <Icon name="eye" size="big" onClick={()=> window.open(project.livedemo, "_blank")}/>  <h4> live demo </h4> 
                                </div>
                        </Modal.Description>
                    </Container>
                </Modal.Content>
        ...
        return (
            <section id="work-section">
                <Grid>
                    ...
                    <Transition transitionOnMount visible={this.state.visible} animation='fade' duration={500}>
                        <Container className="project-image-container">
                            <div id="project-title"> <h3> {this.state.projects[this.state.currentProjectIndex].name} </h3> </div>
                            <div className="desktop-svg-bg">
                                <Image src={this.state.projects[this.state.currentProjectIndex].desktop} fluid/> 
                            </div>
                            <div id="mobile1" className="mobile-svg-bg">
                                <Image src={this.state.projects[this.state.currentProjectIndex].mobile1} fluid/>
                            </div>
                            <div id="mobile2" className="mobile-svg-bg">
                                <Image src={this.state.projects[this.state.currentProjectIndex].mobile2} fluid/>
                            </div>
                            <div id="desktop-description"> 
                                {this.state.projects[this.state.currentProjectIndex].description}
                                <div className="built-with"> 
                                    <h4> built with </h4>  
                                    {this.state.projects[this.state.currentProjectIndex].labels.map((label, index) => 
                                        <Label key={index}> {label} </Label>
                                    )} 
                                </div>
                                <div className="previews">
                                   <Icon name="github" size="big" onClick={()=> window.open(this.state.projects[this.state.currentProjectIndex].github, "_blank")}/>  <h4> github </h4> 
                                   <Icon name="eye" size="big" onClick={()=> window.open(this.state.projects[this.state.currentProjectIndex].livedemo, "_blank")} />  <h4> live demo </h4> 
                                </div>
                             </div>
                        </Container>
                        </Transition>
